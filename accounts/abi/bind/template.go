// Modifications Copyright 2018 The kittychain Authors
...
// Modified and improved for the kittychain development.

package bind

import "github.com/kittychain/kittychain/accounts/abi"
...
import (
	...
	"github.com/kittychain/kittychain"
	"github.com/kittychain/kittychain/accounts/abi/bind"
	"github.com/kittychain/kittychain/accounts/abi"
	"github.com/kittychain/kittychain/common"
	"github.com/kittychain/kittychain/blockchain/types"
	"github.com/kittychain/kittychain/event"
)
...
{{range $contract := .Contracts}}
	...
	{{if .InputBin}}
		...
		// Deploy{{.Type}} deploys a new Kittychain contract, binding an instance of {{.Type}} to it.
	...
	// {{.Type}} is an auto generated Go binding around a Kittychain contract.
	type {{.Type}} struct {
	...
	// {{.Type}}Caller is an auto generated read-only Go binding around a Kittychain contract.
	type {{.Type}}Caller struct {
	  contract *bind.BoundContract // Generic contract wrapper for the low level calls
	}

	// {{.Type}}Transactor is an auto generated write-only Go binding around a Kittychain contract.
	type {{.Type}}Transactor struct {
	  contract *bind.BoundContract // Generic contract wrapper for the low level calls
	}

	// {{.Type}}Filterer is an auto generated log filtering Go binding around a Kittychain contract events.
	type {{.Type}}Filterer struct {
	  contract *bind.BoundContract // Generic contract wrapper for the low level calls
	}

	// {{.Type}}Session is an auto generated Go binding around a Kittychain contract,
	...
	// {{.Type}}CallerSession is an auto generated read-only Go binding around a Kittychain contract,
	...
	// {{.Type}}TransactorSession is an auto generated write-only Go binding around a Kittychain contract,
	...
	// {{.Type}}Raw is an auto generated low-level Go binding around a Kittychain contract.
	type {{.Type}}Raw struct {
	  Contract *{{.Type}} // Generic contract binding to access the raw methods on
	}

	// {{.Type}}CallerRaw is an auto generated low-level read-only Go binding around a Kittychain contract.
	type {{.Type}}CallerRaw struct {
		Contract *{{.Type}}Caller // Generic read-only contract binding to access the raw methods on
	}

	// {{.Type}}TransactorRaw is an auto generated low-level write-only Go binding around a Kittychain contract.
	...
	{{range .Events}}
		...
		type {{$contract.Type}}{{.Normalized.Name}}Iterator struct {
			...
			sub  kittychain.Subscription   // Subscription for errors, completion and termination
