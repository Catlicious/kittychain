...
import (
	...
	"github.com/kittychain/kittychain/blockchain/bloombits"
	"github.com/kittychain/kittychain/blockchain/state"
	"github.com/kittychain/kittychain/blockchain/types"
	"github.com/kittychain/kittychain/blockchain/vm"
	"github.com/kittychain/kittychain/common"
	"github.com/kittychain/kittychain/common/math"
	"github.com/kittychain/kittychain/consensus/gxhash"
	"github.com/kittychain/kittychain/event"
	"github.com/kittychain/kittychain/networks/rpc"
	"github.com/kittychain/kittychain/node/cn/filters"
	"github.com/kittychain/kittychain/params"
	"github.com/kittychain/kittychain/storage/database"
	"math/big"
	"sync"
	"time"
)
...
func (b *SimulatedBackend) CallContract(ctx context.Context, call kittychain.CallMsg, blockNumber *big.Int) ([]byte, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) PendingCallContract(ctx context.Context, call kittychain.CallMsg) ([]byte, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) EstimateGas(ctx context.Context, call kittychain.CallMsg) (uint64, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) callContract(ctx context.Context, call kittychain.CallMsg, block *types.Block, statedb *state.StateDB) ([]byte, uint64, bool, error) {
...
func (b *SimulatedBackend) FilterLogs(ctx context.Context, query kittychain.FilterQuery) ([]types.Log, error) {
...
func (b *SimulatedBackend) SubscribeFilterLogs(ctx context.Context, query kittychain.FilterQuery, ch chan<- types.Log) (kittychain.Subscription, error) {
